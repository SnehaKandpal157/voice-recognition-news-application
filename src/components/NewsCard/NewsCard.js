...
const NewsCard = ({ article: { description, publishedAt, source, title, url, urlToImage }, index, activeArticle }) => {
  ...
  return (
    <Card ref={elRef[index]} className={classNames(classes.card, activeArticle === index ? classes.activeCard : null)}>
      <CardActionArea href={url} target="_blank">
        <CardMedia className={classes.media} image={urlToImage || "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS1iKPijPolDCEWyx9OnscOFqrxgkjEvdX6Gg&usqp=CAU"} />
      ...
      <CardActions className={classes.cardActions}>
        <Button size="small" button="primary">Learn More</Button>
